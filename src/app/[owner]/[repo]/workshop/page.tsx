...
export default function WorkshopPage() {
  ...
  const [loadingMessage, setLoadingMessage] = useState<string | undefined>(
    '初始化Wiki生成...' || 'Initializing workshop generation...'
  );
...
Make the workshop content in ${language === 'en' ? 'English' :
  ...
  'English'} language.`
      ...
      addTokensToRequestBody(requestBody, token, repoInfo.type, FIXED_MODEL_PROVIDER, FIXED_MODEL_NAME, false, '', language);
      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        {isLoading && !workshopContent ? (
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md p-4 mb-6">
            <h3 className="text-red-800 dark:text-red-400 font-medium mb-2">{'错误' || 'Error'}</h3>
